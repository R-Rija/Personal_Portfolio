import { __esm, __export, __toCommonJS, __toESM, require_react } from "./chunk-OWUOI2EO.js";
...
function makeLatestValues(props, context, presenceContext, scrapeMotionValues) {
  ...
  if (context && isVariantNode$1 && !isControllingVariants$1 && props.inherit !== false) {
    ...
    if (animate4 === void 0) animate4 = context.animate;
  }
...
function MeasureLayout(props) {
  ...
  return import_react27.default.createElement(MeasureLayoutWithContext, {
    ...props,
    layoutGroup,
    switchLayoutGroup: (0, import_react27.useContext)(SwitchLayoutGroupContext),
    isPresent: isPresent2,
    safeToRemove
  });
}
...
function onlyElements(children) {
  ...
  import_react32.Children.forEach(children, child => {
    if ((0, import_react32.isValidElement)(child)) filtered.push(child);
  });
  return filtered;
}
var AnimatePresence = ({
  ...
  childrenToRender = childrenToRender.map(child => {
    const key = child.key;
    return exiting.has(key) ? child : React4.createElement(PresenceChild, {
      key: getChildKey(child),
      isPresent: true,
      presenceAffectsLayout,
      mode
...
function ReorderItem({
  ...
  return React10.createElement(Component2, {
    drag: axis,
    ...props,
...
function useSpring(source, config = {}) {
  const {
    isStatic
  } = (0, import_react41.useContext)(MotionConfigContext);
...
function getEasingFunction(definition) {
  ...
  if (isCubicBezier(definition)) return cubicBezier2(...definition);
...
var Animation = class {
  constructor(output, keyframes2 = [0, 1], {
    easing,
    duration: initialDuration = defaults.duration,
    delay: delay2 = defaults.delay,
...
for (const key in featureTests2) {
  supports2[key] = () => {
    if (results2[key] === void 0) results2[key] = featureTests2[key]();
    return results2[key];
  };
}
...
var spring2 = ({
  stiffness = defaults2.stiffness,
  damping = defaults2.damping,
  mass = defaults2.mass,
  from = 0,
  to = 1,
  velocity = 0,
...
function pregenerateKeyframes(generator, toUnit = noopReturn) {
  ...
  if (keyframes2.length === 1) keyframes2.push(state.current);
  return {
    keyframes: keyframes2,
    duration: duration / 1e3,
    ...
    return {
      createAnimation: (keyframes2, shouldGenerate = true, getOrigin2, name, motionValue2) => {
        ...
        if (canGenerate(origin) && canGenerate(target)) {
          ...
          settings = Object.assign(Object.assign({}, getKeyframes2(generator, toUnit)), {
            easing: "linear"
          });
          if (motionValue2) {
...
function scrubAnimation(controls2, axisInfo) {
  controls2.pause();
  controls2.forEachNative((animation, {
    easing
  }) => {
    var _a, _b;
...
function useReducedMotionConfig() {
  ...
  const {
    reducedMotion
  } = (0, import_react46.useContext)(MotionConfigContext);
